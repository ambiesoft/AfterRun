...
namespace Ambiesoft.AfterRunLib.Properties {
    ...
    internal class Resources {
        ...
        ///-aws : Set the Window State of AfterRun, &apos;normal&apos; for showing in normal window, &apos;minimized&apos; for minimized w [残りの文字列は切り詰められました]&quot;; に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   Process with id {0} not found に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   Waiting for process ID {0} に類似しているローカライズされた文字列を検索します。
        /// </summary>
